		...
		try (BufferedReader reader = new BufferedReader(new InputStreamReader(System.in))) {
			while (true) {
				...
				case 8:
					...
					break;
				case 9:
					System.out.println("Enter accountid for updation");
					long accountid3 = Long.parseLong(reader.readLine());
					System.out.println("Enter accountholdername for updation");
					String accountHolderName1 = reader.readLine();
					System.out.println("Enter account type: ");
					accountType = reader.readLine();
					System.out.println(bankService.updateBankDetails(accountid3, accountHolderName1, accountType));
					break;
				case 10:
